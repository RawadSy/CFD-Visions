...
// Color based on distance (simulate heat gradient)
function tempColor(x,y){
    ...
    const rC = Math.floor(255*(1-t));   // Hot red near tube
    const bC = Math.floor(255*t);       // Cold blue far
    const gC = 50;
...
// Controls buttons (add to HTML if تريد)
